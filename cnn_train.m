...
%    getBatch function.
% epochs 是做什么的?batchsize做什么的？learningrate体现在哪儿
opts.train = [] ;
opts.val = [] ;
opts.numEpochs = 30 ;   % 300
opts.batchSize = 32 ;
opts.useGpu = false ;
